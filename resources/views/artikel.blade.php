      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <a style="width: 398px; font-size: 22px; font-weight: 500; text-decoration: none; color: black;"
              >Gamelan dan Wayang Menjadi Media Pembelajaran yang Diminati
              Sekolah di London</a
            >
            <hr style="width: 398px; border: 1px solid black" />
            <p
              style="
                font-size: 22px;
                font-weight: 300;
          ...
          <div class="col-md-4">
            ...
            <a style="width: 398px; font-size: 22px; font-weight: 500; color: black; text-decoration: none;" href="/isi-a"
          ...
          <div class="col-md-4">
            ...
            <a style="width: 398px; font-size: 22px; font-weight: 500; color: black;"
              >St. Mary College Australia Selami Kekayaan Budaya Indonesia
              Bersama KJRI Sydney</a
            >
            <hr style="width: 398px; border: 1px solid black" />
            <p
              style="
